...
def make_loss(cfg, num_classes):    # modified by gu
    ...
    if cfg.DATASETS.NAMES == 'disfa':
        # Enhanced pos_weights for sparse AUs: 1, 2, 4, 5, 6, 9, 12, 15, 17, 20, 25, 26
        # AU1:15, AU2:18, AU4:5, AU5:40, AU6:10, AU9:20, AU12:6, AU15:20, AU17:8, AU20:30, AU25:2, AU26:7
        pos_weights = torch.tensor([15.0, 18.0, 5.0, 40.0, 10.0, 20.0, 6.0, 20.0, 8.0, 30.0, 2.0, 7.0]).cuda()
