...
_C.SOLVER = CN()
# --------------------------------------------------
# Two-stage training for AU detection
# --------------------------------------------------

_C.SOLVER.STAGE1 = CN()
_C.SOLVER.STAGE1.MAX_EPOCHS = 10
_C.SOLVER.STAGE1.BASE_LR = 0.0001
...
_C.SOLVER.STAGE2.LARGE_FC_LR = True
_C.SOLVER.STAGE2.ATTN_PENALTY_WEIGHT = 1.0
# Name of optimizer
