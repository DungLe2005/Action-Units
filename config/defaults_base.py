...
# GPU IDs exposed to the training process, e.g. [0] or [0, 1].
...
_C.SOLVER.STAGE1.CLASS_SPECIFIC_PROMPTS = False
_C.SOLVER.STAGE1.USE_DATA_PARALLEL = False
...
_C.SOLVER.STAGE2.BACKBONE_LR_FACTOR = 1.0
_C.SOLVER.STAGE2.OPTIMIZER_NAME = "Adam"
_C.SOLVER.STAGE2.WEIGHT_DECAY = 0.0005
_C.SOLVER.STAGE2.POS_WEIGHT_POWER = 1.0
_C.SOLVER.STAGE2.POS_WEIGHT_MAX = 0.0
_C.SOLVER.STAGE2.ITC_LOSS_WEIGHT = 0.0
_C.SOLVER.STAGE2.INIT_HEAD_BIAS_FROM_PRIOR = True
...
_C.SOLVER.STAGE2.AMP = False
_C.SOLVER.STAGE2.EARLY_STOP_PATIENCE = 0
_C.SOLVER.STAGE2.EARLY_STOP_MIN_DELTA = 0.0
_C.SOLVER.STAGE2.MAX_LOGIT_ABS = 0.0
_C.SOLVER.STAGE2.FATAL_LOGIT_ABS = 0.0
_C.SOLVER.STAGE2.MAX_LOGIT_WARNINGS = 5
_C.SOLVER.STAGE2.MAX_GRAD_NORM = 5.0
