...
def load(name: str, device: Union[str, torch.device] = "cuda" if torch.cuda.is_available() else "cpu", jit=False, h_resolution=14, w_resolution=14, vision_stride_size=16):
    """Load a CLIP model
